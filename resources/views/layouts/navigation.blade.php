<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="auth()->check() ? route('dashboard') : route('public.index')" 
                                :active="request()->routeIs('dashboard') || request()->routeIs('admin.dashboard') || request()->routeIs('public.index') || request()->routeIs('public.portfolio.show')">
                ...
                @auth
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            {{-- <x-dropdown-link :href="route('portfolio.manage')">
                                {{ __('Profile') }}
                            </x-dropdown-link> --}}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="auth()->check() ? route('dashboard') : route('public.index')" :active="request()->routeIs('public.index') || request()->routeIs('public.portfolio.show')">
                {{ __('Daftar Anggota') }}
        ...
        @auth
            <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <x-responsive-nav-link :href="route('portfolio.manage')">
                        {{ __('Profile') }}
                    </x-responsive-nav-link>
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
