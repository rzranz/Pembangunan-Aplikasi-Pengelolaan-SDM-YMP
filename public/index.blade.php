<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                 @auth
                    <a href="{{ route('dashboard') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Dashboard Saya</a>
                @else
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            {{-- ========================================================== --}}
            {{-- FORMULIR PENCARIAN DAN FILTER DITAMBAHKAN DI SINI --}}
            {{-- ========================================================== --}}
                ...
                <form action="{{ route('public.index') }}" method="GET">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="search" id="search" value="{{ $searchQuery ?? '' }}" placeholder="Masukkan nama talenta..." class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-900 dark:border-gray-600 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                        {{-- Filter Kategori --}}
                        <div>
                                ...
                                @empty
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        <td colspan="5" class="px-6 py-4 text-center">
                                            Tidak ada talenta yang ditemukan sesuai kriteria pencarian.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
